...
public class AuthSendingEmailStrategy implements SendingEmailStrategy {

    private final String url;
    private final String username;
    private final String authKey;

    public AuthSendingEmailStrategy(String url, String username, String authKey) {
        this.url = url;
    ...
    public void fillMessage(MimeMessage message) {
        try {
            ...
            message.setSubject("회원가입 이메일 인증 - SGWinterCamp AuthSystem", charSet);
            ...
            message.setText(new StringBuffer()
                ...
                .append("            SGWinterCamp AuthSystem을 이용해 주셔서 감사합니다.<br style=\"margin: 0; font-family: 'GmarketSans'; box-sizing: border-box; text-decoration: none; color: inherit;\">\n")
                ...
                .append("            메일 인증을 하지 않을 경우, SGWinterCamp AuthSystem에 로그인이 불가능 합니다.<br style=\"margin: 0; font-family: 'GmarketSans'; box-sizing: border-box; text-decoration: none; color: inherit;\">\n")
                .append("            감사합니다.\n")
                .append("        </p>\n")
                ...
                .append("            ⓒ SmileGate WinterCamp - Auth System\n")
                .append("        </div>\n")
                .append("    </footer>\n")
                .append("</div>\n")
                .append("</body>\n")
